...
<hr><hr><hr><hr>
    <div class="container mt-5">
        ...
        <h2 class="mb-4">Lista de Registros de Administradores</h2>
        ...
        <form action="{{ route('import.administradores') }}" method="POST" enctype="multipart/form-data" class="d-flex flex-column align-items-center gap-3">
    @csrf
