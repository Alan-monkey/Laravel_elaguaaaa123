...
<hr><hr><hr><hr>
    <div class="container mt-5">
        ...
        <h2 class="mb-4">Lista de Registros de Garrafones</h2>
    ...
    Exportar a Excel
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
@foreach ($data as $garrafon)
    <tr>
        <td>{{ $garrafon['id_garrafon'] }}</td>
        <td>{{ $garrafon['estado'] }}</td>
        <td>{{ $garrafon['peso'] }}</td>
        <td>{{ $garrafon['marca'] }}</td>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Acciones de registro">
                                    ...
                                    <a href="{{ url('/editar-apiGar/' . $garrafon['id_garrafon']) }}" 
                                       class="btn btn-warning btn-sm" 
                                       title="Editar registro">
                                        <i class="bi bi-pencil"></i> Editar
                                    </a>
                                  
                                    <a href="{{ url('/consultar2-apiGar/' . $garrafon['id_garrafon']) }}" 
                                       class="btn btn-primary btn-sm"
                                       title="Ver detalles">
                                        <i class="bi bi-eye"></i> Detalle
                                    </a>
                                    
                                    <a href="{{ url('/borrar-apiGar/' . $garrafon['id_garrafon']) }}" 
