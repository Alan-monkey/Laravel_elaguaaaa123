    ...
    <div class="container">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('enviar.datosCam') }}" method="POST">
                    @csrf <!-- Protección CSRF -->

                    <div class="mb-3">
                        <label for="placas" class="form-label">
                            <i class="bi bi-card-text"></i> Placas
                        </label>
                        <input type="text" class="form-control" name="placas" id="placas" value="{{ old('placas') }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="capacidad" class="form-label">
                            <i class="bi bi-calendar"></i> Capacidad
                        </label>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ url('/consultar-apiCam') }}" class="btn btn-dark">
