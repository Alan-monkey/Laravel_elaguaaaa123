...
class ControllerAdmin extends Controller
{
    public function getDataAdm(Request $request)
    {
        ...
        $url = "http://127.0.0.1:3000/tb_administrador?page={$page}";
        if ($searchTerm) {
  ...
  public function welcome_admin()
    ...
    public function getData2Adm($id){
        ...
        $response = Http::get('http://127.0.0.1:3000/id_administrador/'. $id);
    ...
    public function deleteDataAdm($id)
    {
        ...
        $response = Http::delete('http://127.0.0.1:3000/eli_administrador/' . $id);
    ...
    public function actualizarAdm(Request $request, $id)
    {
        ...
        $response = Http::put('http://127.0.0.1:3000/act_administrador/' . $id, [
    ...
    public function postDataAdm(Request $request) {
        ...
        $response = Http::post('http://127.0.0.1:3000/registro_administrador/', [
